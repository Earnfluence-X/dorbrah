...
export const seedProducts: SeedProduct[] = [
  ...
  {
    slug: "ola-gold-antique",
    name: "Ola Gold Antique",
    collection: "Heritage",
    colorway: "Antique Gold & Umber",
    colorFamily: "Gold",
    description:
      "The Adaeze sunburst re-dyed in antique gold and umber — the same blessed circle, aged like bronze in a family shrine. A colorway siblings' favourite.",
    story:
  ...
  },
  {
    ...
    colorFamily: "Blue",
    description:
      "Indigo Alaba pushed past midnight — navy so deep the circles surface only when you move. Chairman cloth.",
    story:
  ...
  },
  {
    ...
    colorFamily: "Blue",
    description:
      "Alaba's circles electrified to cobalt — celebratory indigo with voltage. December owambe season, sorted.",
    story:
  ...
  },
  {
    ...
    story:
      "Umber is the colour of the compound wall at our founder's family home in Jos. This bath is mixed to memory.",
